...
export const CFG = {
    ...
    PLAYER_X: 240, // Closer to left edge for better visibility
...
export const WORLDS: WorldTheme[] = [
    {
        // World 0: Clean ice-blue — calm, welcoming
        name: 'PAPER HANDS',
        startScore: 0,
        skyTop: '#FFFFFF',
        skyMid: '#F5F8FF',
    ...
    {
        // World 2: Deep teal/emerald — underwater feel
        name: 'DIAMOND HANDS',
        startScore: 250,
        skyTop: '#F0FFFE',
        skyMid: '#D8FFF8',
        ...
        groundBottom: '#60C0A8',
        accent: '#00C9A7',
        grid: 'rgba(0,201,167,0.07)',
        redA: '#FF6070', redB: '#E04858',
        greenA: '#18E8A0', greenB: '#10C888',
        floorPattern: 'waves',
        starColor: '#00C9A7',
        particleColor: '#66FFD8',
        cloudColor: 'rgba(0,201,167,0.05)',
        shimmer: 0.65,
    },
    {
        ...
        cloudColor: 'rgba(139,92,246,0.06)',
        shimmer: 0.7,
    },
    {
        // World 4: Electric neon blue — cyberpunk vibe
        name: 'TO THE MOON',
        startScore: 700,
        skyTop: '#F0F8FF',
        skyMid: '#D8EEFF',
    ...
    },
    {
        ...
        starColor: '#F0B90B',
        particleColor: '#FFD866',
        cloudColor: 'rgba(240,185,11,0.05)',
        shimmer: 0.8,
    },
    {
    ...
    },
    {
        ...
        groundBottom: '#D07080',
        accent: '#FF2060',
        grid: 'rgba(255,32,96,0.08)',
        redA: '#FF3050', redB: '#E02040',
        greenA: '#14E89A', greenB: '#0EC080',
        floorPattern: 'pulse',
        starColor: '#FF2060',
        particleColor: '#FF88AA',
        cloudColor: 'rgba(255,32,96,0.05)',
        shimmer: 0.9,
    },
    {
        ...
        groundBottom: '#585888',
        accent: '#00FFD0',
        grid: 'rgba(0,255,208,0.06)',
        redA: '#FF4060', redB: '#E03050',
        greenA: '#20F0A0', greenB: '#10D888',
        floorPattern: 'circuit',
        starColor: '#00FFD0',
        particleColor: '#88FFE0',
        cloudColor: 'rgba(0,255,208,0.04)',
        shimmer: 0.95,
    },
    {
        ...
        groundBottom: '#E0D098',
        accent: '#FFD700',
        grid: 'rgba(255,215,0,0.08)',
        redA: '#FF6080', redB: '#E04868',
        greenA: '#40FFD0', greenB: '#28E8B8',
        floorPattern: 'grid',
        starColor: '#FFD700',
        particleColor: '#FFE888',
        cloudColor: 'rgba(255,215,0,0.06)',
        shimmer: 1.0,
    },
]
...
export function updateGameConfig(width: number, height: number) {
    ...
    if (isPortrait) {
        ...
        CFG.PLAYER_X = clamp(width * 0.16, 90, 180);
